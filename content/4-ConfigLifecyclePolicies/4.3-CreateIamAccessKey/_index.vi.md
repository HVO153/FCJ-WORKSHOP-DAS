...
Bạn đã tạo một User IAM ở các bước trước, phần này bạn sẽ tạo một khóa truy cập nhằm giúp xác thực khi gửi dữ liệu từ project.
1. Truy cập [IAM](https://us-east-1.console.aws.amazon.com/iam/home)
